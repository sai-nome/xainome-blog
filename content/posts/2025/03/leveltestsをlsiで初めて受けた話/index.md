...
slug: "leveltests-lsi"
aliases:
  - "/posts/2025/03/leveltestsをlsiで初めて受けた話/"
categories: 
  - "ニュージーランド"
tags: 
  - "leveltests"
...
[LSI](/posts/2025/01/lsi-auckland-1-review/)ではLevelTestsがあります。これは今のレベルから次のレベルへ移動したい場合に受けることができます。詳しいことは[ハンドブック](https://www.lsi.edu/course_info/aucklandstudenthandbook.pdf)に書かれています。

私の今のレベルがpre-intermediateになります。TOEICだと500あるかないかぐらいのレベルになります。IELTSだと3-4くらいらしいです。

### **LevelTestsの内容**

そのLevelTestsですが内容としてはそこまで難しくないと思います。ただ、テキストブックの内容をある程度網羅している必要があります。逆に言えばそこを網羅できていれば上に上がるのは容易とも言えます。

LevelTestsではgrammarとvocabulary、writingになります。なので勉強ができる人は簡単に上に上がることができますね。日本人的にはListeningとSpeakingが苦手なのでこの方法だと微妙な感じもあります。

### **レベルアップの条件**

ただ、いくつか次のLevelに行くには条件があります。

- WeeklyTestで3回連続80％以上取ること

- Mid-Book Testで教材の内容と全体的な能力が次のレベルでも問題ないことを示す

WeeklyTestはその週の教材の理解度を図ります。これはvocabularyとgrammarさえ覚えておけば特に問題ないと思います。
...
各項目ごとに%で評価されます。とは言えWritingとSpeaking以外はペーパーテストなのでテキストの内容さえ把握していれば大丈夫です。

WritingとSpeakingはおそらくIELTS基準な気がします。文法にミスがなく少し難しい語彙を混ぜることですね。更に段落に分けたり、接続語を使うようにするといい評価になると思います。それから深堀することですね。なるべく1つの内容を深堀するといいらしいです。

Speakingはそこに流暢さや発音の良さが加わります。ここが苦戦するポイントになるかもしれません。

###   
LevelTests**合格ライン**

ここの評価が良ければLevelTestsの推薦を受けることができます。ただ、ここの推薦が受けれなくてもある程度点数を取っていればWeeklyTest次第で受けられると思います。

長々と話しましたが、LevelTestsは合格しました。75%とることができれば合格になります。とは言えテキストの内容を全て把握できていれば問題ないのですが。

ぶっちゃけ今のクラスは居心地いいし、先生も面白いのでそのままのほうがいいんですよね。とは言え上達のために頑張っていきます。ではでは。
...
この調子で、英語の文法や語彙、そして自然な表現を意識して練習していけば、もっと点数が上がるはずやけん、がんばってみんしゃい！
